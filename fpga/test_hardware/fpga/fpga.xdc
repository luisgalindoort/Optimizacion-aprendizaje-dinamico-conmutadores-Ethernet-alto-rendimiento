...
set_output_delay 0.000 [get_ports {uart_txd uart_cts}]
set_false_path -from [get_ports {uart_rxd uart_rts}]
set_input_delay 0.000 [get_ports {uart_rxd uart_rts}]
...
# SFP+ Interface
# set_property -dict {LOC D2} [get_ports sfp0_rx_p]
# set_property -dict {LOC D1} [get_ports sfp0_rx_n]
# set_property -dict {LOC E4} [get_ports sfp0_tx_p]
# set_property -dict {LOC E3} [get_ports sfp0_tx_n]
# set_property -dict {LOC C4} [get_ports sfp1_rx_p]
# set_property -dict {LOC C3} [get_ports sfp1_rx_n]
# set_property -dict {LOC D6} [get_ports sfp1_tx_p]
# set_property -dict {LOC D5} [get_ports sfp1_tx_n]
# set_property -dict {LOC B2} [get_ports sfp2_rx_p]
# set_property -dict {LOC B1} [get_ports sfp2_rx_n]
# set_property -dict {LOC B6} [get_ports sfp2_tx_p]
# set_property -dict {LOC B5} [get_ports sfp2_tx_n]
# set_property -dict {LOC A4} [get_ports sfp3_rx_p]
# set_property -dict {LOC A3} [get_ports sfp3_rx_n]
# set_property -dict {LOC A8} [get_ports sfp3_tx_p]
# set_property -dict {LOC A7} [get_ports sfp3_tx_n]
# set_property -dict {LOC C8} [get_ports sfp_mgt_refclk_0_p]
# set_property -dict {LOC C7} [get_ports sfp_mgt_refclk_0_n]
