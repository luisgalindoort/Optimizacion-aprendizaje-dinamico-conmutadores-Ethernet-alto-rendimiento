...
clean:: tmpclean
	...
	-rm -rf *_timing.rpt *_timing_summary.rpt
...
$(PROJECT).runs/impl_1/$(PROJECT)_routed.dcp: $(PROJECT).runs/synth_1/$(PROJECT).dcp
	...
	echo "report_timing -file $(PROJECT)_timing.rpt" >> run_impl.tcl
	echo "report_timing_summary -file $(PROJECT)_timing_summary.rpt" >> run_impl.tcl
